...
treesitter_configs.setup {
    ...
    -- Prevent: https://github.com/LazyVim/LazyVim/issues/524
    ignore_install = { "help" },
    ...
    highlight = {
        ...
        -- filetype, you need to include `latex` in this list as this is the
        -- name of the parser) list of language that will be disable disable =
        -- { "c", "rust" }, Or use a function for more flexibility, e.g. to
